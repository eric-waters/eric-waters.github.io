...
function sendEmail(nameInput, orgInput, emailInput, messageInput) {
  ...
  if (nameInput != "" && messageInput != "") {
    Email.send({
      ...
      Body: "".concat(nameInput, " (").concat(emailInput, ") from ").concat(orgInput, " has sent the following message:\n            ").concat(messageInput)
    }).then(function (message) {
      return alert('Thanks! I will get back to you as soon as I can.');
